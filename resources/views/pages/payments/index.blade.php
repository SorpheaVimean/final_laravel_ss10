...
@endif
        ...
        <div class="max-w-screen-2xl mx-auto sm:px-6 lg:px-8">
          <div class="flex justify-between items-center mb-4">
            <h1 class="text-2xl font-bold text-white">Total Payments Methods: {{ count($payments) }}</h1>
                      ...
                      <table
                        ...
                        <tbody>
                            ...
                            <tr class="border-b border-neutral-200 dark:border-white/10">
                                ...
                                <td class="whitespace-nowrap  px-6 py-4">{{ $payment->name }}</td>
                                <td class="whitespace-nowrap  px-6 py-4">{{ $payment->description }}</td>
                                <td class="whitespace-nowrap px-6 py-4 {{ $payment->status === 1 ? 'text-green-600 font-bold' : 'text-red-600' }}">
